...
app.get('/prototypes/collect-gestes', (req, res) => {
    res.sendFile(__dirname + '/src/html/prototypes-collect-gestes.html');
});
...
app.get('/prototypes/code', (req, res) => {
    res.sendFile(__dirname + '/src/html/prototypes-code.html');
});
...
app.get('/prototypes/rush-cadre', (req, res) => {
