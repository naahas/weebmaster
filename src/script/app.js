    ...
    data() {
        return {
            ...
            modes: [
                ...
                { id: 'classic',   name: 'Classique', kind: 'Solo',   players: '∞',  img: 'kenshin2.jpeg', plain: true,
                ...
                { id: 'ascension', name: 'Ascension', kind: 'Solo',   players: '∞',  img: 'kenshin2.jpeg', plain: true, soon: true,
                  desc: "Grimpe la tour, un mini-jeu différent à chaque étage." },
                { id: 'duel',      name: 'Duel',      kind: '1 v 1',  players: '2',  img: 'kenshin2.jpeg', plain: true, soon: true,
                  desc: "Face à face en une manche. Un seul survivant." },
                { id: 'tournoi',   name: 'Tournoi',   kind: 'Bracket', players: '32', img: 'kenshin2.jpeg', plain: true, soon: true,
                  desc: "Élimination directe jusqu'à la finale." },
                { id: 'blindtest', name: 'Blind test', kind: 'Solo',  players: '∞',  img: 'kenshin2.jpeg', plain: true, soon: true,
                  desc: "Reconnais l'opening en quelques secondes." },
                { id: 'chrono',    name: 'Chrono',    kind: 'Solo',   players: '∞',  img: 'kenshin2.jpeg', plain: true, soon: true,
